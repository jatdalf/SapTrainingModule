...
,{        id: '3',
      ...
      explicacion: 'Transacción utiizada para solicitar insumos, normalmente, desde el warehouse central en Bs. As. Hacia el resto de las sucursales.'}
,{        id: '4',
      nombre: 'Migo',
...
,{        id: '6',
      nombre: 'Ysd_Imposicion',
      uso: 'Imposicion de equipos precargados',
      explicacion: 'Imposición de ECOs o piezas generadas por interfaz; es decir, todo aquello que tiene datos precargados como destinatarios, destino, etc'}
,{        id: '7',
      nombre: 'yupdcontimas',
